...
<script>
{
        ...
        for( var i=0;i<cnt; i++){
                ...
                document.write( "<TD><input name='cbList1' type='checkbox' id='" + jsThrdIdOb[i].id  + "'" );
                document.write( "<TD>" +  jsThrdIdOb[i].name );
...
<script>
{
        var cnt = jsThrdOb.length;
        for( var i=0;i<cnt; i++){
                document.write( "<TR>" );
                document.write( "<TH>" + jsThrdOb[i].id );
                document.write( "<TD>" + jsThrdOb[i].name );
                document.write( "<TD>" + jsThrdOb[i].state );
                document.write( "<TD>" + jsThrdOb[i].cpuTime );
                document.write( "<TD>" + jsThrdOb[i].userTime );
        }
}
</script>
</TABLE>
